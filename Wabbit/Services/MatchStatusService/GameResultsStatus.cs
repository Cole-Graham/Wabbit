...
namespace Wabbit.Services
{
    public partial class MatchStatusService
    {
        ...
        public async Task<DiscordMessage> UpdateToGameResultsStageAsync(DiscordChannel channel, Round round, DiscordClient client)
        {
            ...
            round.CustomProperties["Instructions"] = $"The game will be played on **{round.Maps?.LastOrDefault() ?? "Unknown Map"}**. After the match completes, select the winner using the dropdown below.";
